...
class PartnerSaleSupplement(models.Model):
...
ser hijos de un Contrato Marco y de un Contrato a la vez"""
        ...
        return super(PartnerSaleSupplement, self).create(vals)
    ...
    def unlink(self):
        ...
        return super(PartnerSaleSupplement, self).unlink()
    ...
    def write(self, vals):
        if self.state in ("active", "done", "cancel"):
            return super(PartnerSaleSupplement, self).write(vals)
...
puede ser menor que la fecha de aprobación del padre"""
    ...
    def name_get(self):
        ...
        return super(PartnerSaleSupplement, self).name_get()
