...
class Partner(models.Model):
    ...
    contract_sale_ids = fields.One2many('partner.contract', 'partner_id',
    'Sales Contracts',domain=[('sales', '=', True), ('type', '=', 'contract')])
    supplement_sale_ids = fields.One2many('partner.contract', 'partner_id',
    'Sales Contracts',domain=[('sales', '=', True), ('type', '=', 'supplement')])
    frame_contract_purchase_ids = fields.One2many('partner.purchase.frame.contract',
    'partner_id','Purchase Frame Contracts')
    contract_purchase_ids = fields.One2many('partner.contract', 'partner_id',
    'Sales Contracts',domain=[('purchases', '=', True), ('type', '=', 'contract')])
    supplement_purchase_ids = fields.One2many('partner.contract', 'partner_id',
    'Sales Contracts',domain=[('purchases', '=', True), ('type', '=', 'supplement')])
    """
